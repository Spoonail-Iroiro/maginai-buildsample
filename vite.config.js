...
export default defineConfig({
  build: {
    target: 'es2015',
    outDir: resolve(__dirname, 'game/game/js/mod/mods/buildsample'),
    emptyOutDir: true,
    lib: {
      entry: resolve(__dirname, 'js/mod/mods/buildsample/init.js'),
      name: 'buildsample',
      formats: ['iife'],
    },
    rollupOptions: {
  ...
  plugins: [
    {
      ...
      closeBundle: async () => {
        ...
        const devRoot = 'js/mod/mods/buildsample';
        const buildRoot = 'game/game/js/mod/mods/buildsample';
        try {
